...
async function runBackfill() {
  ...
  if (detach) {
    ...
    // No pre-spawn close: this process holds a LIVE connection whose shared
    // DMS lock denies the child the exclusive lock a wal-index reset needs
    // (db.ts closeDbBeforeChildSpawn), and it exits immediately afterwards.
